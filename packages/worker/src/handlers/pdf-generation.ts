...
<body>
  ...
  <div class="footer">
    <p>Generated by Shrubb AI Yard Planner</p>
  </div>
</body>
</html>`;
  ...
  const storagePath = `${userId}/${projectId}/${fileId}.html`;
  ...
  // 6. Track usage (minimal cost for PDF generation itself)
  ...
  await incrementSpending(supabase, userId, Math.ceil(pdfCost * 100));
